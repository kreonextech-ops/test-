    ...
    <main className="relative min-h-screen" style={{ background: "#FAF5EC" }}>
      ...
      <section className="relative w-full overflow-hidden" style={{ height: "clamp(280px, 55vw, 560px)" }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-between pointer-events-none">
          <motion.div initial={{ scaleX: 0 }} animate={{ scaleX: 1 }} transition={{ duration: 1, delay: 0.5 }} style={{ originX: 0, width: "clamp(60px, 15vw, 160px)", height: "clamp(5px, 1vw, 8px)", background: "#C9A87C" }} />
          <motion.div initial={{ scaleX: 0 }} animate={{ scaleX: 1 }} transition={{ duration: 1, delay: 0.5 }} style={{ originX: 1, width: "clamp(60px, 15vw, 160px)", height: "clamp(5px, 1vw, 8px)", background: "#C9A87C" }} />
        </div>
      ...
      <section className="w-full">
        <div className="flex flex-col md:grid md:grid-cols-2" style={{ minHeight: "clamp(360px, 80vw, 760px)" }}>
          ...
          <motion.div
            ...
            <div className="space-y-6">
              <p className="font-sans font-light leading-[1.9]"
                style={{ fontSize: "clamp(9px, 1.4vw, 14px)", color: "rgba(255,255,255,0.72)" }}>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="mt-12"
              style={{ background: "rgba(201,168,124,0.12)", borderLeft: "2px solid #C9A87C", padding: "clamp(10px, 2vw, 18px) clamp(12px, 2.5vw, 20px)", borderRadius: "0 4px 4px 0" }}>
      ...
      {/* ── PRINCIPLES ── */}
      <section className="w-full">
        <div className="flex flex-col-reverse md:grid md:grid-cols-2" style={{ minHeight: "clamp(360px, 80vw, 700px)" }}>
          ...
          <motion.div
            ...
            <div className="flex md:flex-col overflow-x-auto no-scrollbar gap-4 md:gap-3.5 pb-4 -mx-4 px-4 md:px-0 md:mx-0">
              {principles.map((p, i) => (
                <motion.div
                  key={p.title}
                  initial={{ opacity: 0, y: 10 }}
                  ...
                  style={{ background: "rgba(201,168,124,0.08)", borderLeft: "2px solid #C9A87C", padding: "clamp(16px, 1.8vw, 24px)", borderRadius: "0 4px 4px 0" }}>
                  ...
                  <p className="font-sans font-light leading-relaxed"
                    style={{ fontSize: "13px", color: "rgba(255,255,255,0.6)", paddingLeft: "14px" }}>
                    {p.body}
                  </p>
                </motion.div>
              ))}
      ...
      <section className="relative overflow-hidden" style={{ background: "#0D3B2E", padding: "clamp(28px, 6vw, 80px) clamp(16px, 4vw, 56px)" }}>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            style={{ marginBottom: "clamp(20px, 5vw, 52px)", textAlign: "center" }}
          >
          ...
          <div className="flex md:grid md:grid-cols-3 overflow-x-auto no-scrollbar gap-4 md:gap-6 pb-6 -mx-4 px-4 md:mx-0 md:px-0">
            {values.map((v, i) => (
              <motion.div
                key={v.num}
                ...
                transition={{ delay: i * 0.1 }}
                viewport={{ once: true }}
                className="flex-shrink-0 w-[75vw] md:w-auto"
                style={{ border: "1px solid rgba(201,168,124,0.2)", padding: "clamp(20px, 3vw, 36px) clamp(16px, 2.5vw, 28px)", borderRadius: "0" }}>
                <div className="font-serif italic"
                  style={{ fontSize: "clamp(24px, 5vw, 48px)", color: "rgba(201,168,124,0.25)", lineHeight: 1, marginBottom: "16px" }}>
                  {v.num}
                </div>
                <div style={{ height: "1px", background: "rgba(201,168,124,0.3)", marginBottom: "16px" }} />
                ...
                <p className="font-sans font-light leading-relaxed"
                  style={{ fontSize: "13px", color: "rgba(255,255,255,0.58)", paddingLeft: "14px" }}>
                  {v.body}
                </p>
              </motion.div>
            ))}
