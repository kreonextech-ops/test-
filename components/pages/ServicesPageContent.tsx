...
const services = [
  {
    ...
    tagline: "Beautiful and practical layout design.",
    description:
      "Great interior design starts with a good layout. We study how you use your space to plan the best flow and placement for everything. We use 3D models to show you exactly how your room will look before any work begins.",
  ...
  },
  {
    ...
    tagline: "Choosing the perfect materials.",
    description:
      "Good design is about picking the right materials, colors, and lighting. We work with trusted makers and suppliers to pick the best items for your home. From custom-made sofas to carefully chosen stone, everything is selected to match your taste perfectly.",
  ...
  },
  {
    ...
    tagline: "Managing everything from start to finish.",
    description:
      "We promise smooth and easy execution. Our team manages all the builders and suppliers to make sure your project is finished on time, within budget, and to the highest standard. We keep you updated, supervise the site, and are always available even after you move in.",
