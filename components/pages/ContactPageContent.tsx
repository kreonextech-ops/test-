...
const officeInfo = [
  { label: "Studio Address", value: "BHOGAL BROTHERS, BAGDOGRA,\nBIHAR MORE, PIN CODE- 734014" },
  { label: "Email Us", value: "info@urbansaajh.com\nsinghtejinder428@gmail.com" },
  { label: "Call Us", value: "+91-7602016708" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-24">
            ...
            >
              <h2 className="text-4xl font-serif mb-12">
                Start Your <br /><span className="italic text-gray-400 font-light">Design Journey</span>
              </h2>
            ...
            >
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-14">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-14">
                  {[
                    { id: "inquiry", label: "Type of Project", options: ["Home Interior Design", "Office Workspace Design", "General Consultation", "Other"] },
